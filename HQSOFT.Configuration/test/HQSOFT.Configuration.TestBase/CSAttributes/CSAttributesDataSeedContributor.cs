...
{
    public class CSAttributesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly ICSAttributeRepository _cSAttributeRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public CSAttributesDataSeedContributor(ICSAttributeRepository cSAttributeRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _cSAttributeRepository.InsertAsync(new CSAttribute
            (
                id: Guid.Parse("d6723d82-c265-4f07-9328-80c8cea6eddc"),
            ...
            await _cSAttributeRepository.InsertAsync(new CSAttribute
            (
                id: Guid.Parse("7e1208c2-5d95-4066-91e8-3fd4cb98788d"),
