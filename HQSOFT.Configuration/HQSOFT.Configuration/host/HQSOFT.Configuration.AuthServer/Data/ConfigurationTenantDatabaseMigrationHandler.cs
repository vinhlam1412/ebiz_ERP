...
namespace HQSOFT.Configuration.Data;

public class ConfigurationTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<ConfigurationTenantDatabaseMigrationHandler> _logger;

    public ConfigurationTenantDatabaseMigrationHandler(
        IDbContextProvider<AuthServerHostMigrationsDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<ConfigurationTenantDatabaseMigrationHandler> logger)
    {
