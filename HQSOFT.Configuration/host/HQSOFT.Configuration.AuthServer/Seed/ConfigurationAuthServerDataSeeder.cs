 ...
 */
public class ConfigurationAuthServerDataSeeder : ITransientDependency
{
    ...
    public ConfigurationAuthServerDataSeeder(
    ...
    {
        if (await _scopeManager.FindByNameAsync("Configuration") == null)
        {
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["Configuration_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["Configuration_Web:ClientSecret"] ?? "1q2w3e*",
        ...
        {
            var consoleAndAngularClientRootUrl = configurationSection["Configuration_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
