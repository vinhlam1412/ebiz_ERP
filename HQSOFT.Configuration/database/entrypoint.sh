...
/opt/mssql-tools/bin/sqlcmd -S sqlserver -U SA -P $SA_PASSWORD -Q "CREATE DATABASE [$Configuration_DB]"

/opt/mssql-tools/bin/sqlcmd -d $AuthServer_DB -S sqlserver -U sa -P $SA_PASSWORD -i migrations-AuthServerHost.sql
/opt/mssql-tools/bin/sqlcmd -d $Configuration_DB -S sqlserver -U sa -P $SA_PASSWORD -i migrations-Configuration.sql